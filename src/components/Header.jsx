...
export default function Header() {
    return(
    <header className="fixed top-0 left-0 right-0 px-10 py-3 flex justify-between bg-stone-50 border-b-[0.5px] border-stone-900" >
        <div>
            <Link to="/"><img src={Logo} className="h-6" alt="Logo Re.use" /></Link>
        </div>
        <nav className="font-sans flex gap-12 items-center">
